...
var table_full = document.getElementById('trip-table');
var table_body = document.getElementById('trip-table-body');
var search_input = document.getElementById('trip-search');
...
$(document).ready(function () {
  $('#trip-table tfoot th').each(function () {
      var title = $(this).text();
